...
#define MAINMODE		0				// Режим работы: 0 - Работа циклическая, 1- разовый цикл от внешнего запуска

#define TMAIN				1200		// миллисекунд
#define TGEN				400			// Длительность работы излучателя в периодах колебаний генератора
